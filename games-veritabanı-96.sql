...
-- oyun-96 için veritabanı yapısı dökülüyor
CREATE DATABASE IF NOT EXISTS `oyun-96` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `oyun-96`;

-- tablo yapısı dökülüyor oyun-96.oyun
...
-- oyun-96.oyun: ~0 rows (yaklaşık) tablosu için veriler indiriliyor
/*!40000 ALTER TABLE `oyun` DISABLE KEYS */;
/*!40000 ALTER TABLE `oyun` ENABLE KEYS */;

-- tablo yapısı dökülüyor oyun-96.tur
...
-- oyun-96.tur: ~0 rows (yaklaşık) tablosu için veriler indiriliyor
/*!40000 ALTER TABLE `tur` DISABLE KEYS */;
/*!40000 ALTER TABLE `tur` ENABLE KEYS */;

-- tablo yapısı dökülüyor oyun-96.yayinci
CREATE TABLE IF NOT EXISTS `yayinci` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ktarih` date DEFAULT NULL,
  `personel` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- oyun-96.yayinci: ~0 rows (yaklaşık) tablosu için veriler indiriliyor
